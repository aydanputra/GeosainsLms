...
export default async function Page() {
  ...
  if (!profileData) redirect('/login?redirect=/dashboard/profile');
  if ((profileData.initialUser as any).role === 'ADMIN' && Boolean((profileData.initialUser as any).isSuperAdmin)) redirect('/dashboard/settings');
