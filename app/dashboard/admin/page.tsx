...
import AdminDashboard from '@/modules/dashboard/pages/admin/AdminDashboard';
...
export default async function Page() {
  ...
  const formattedOrders = orders.map(o => ({
    id: o.id,
    userId: o.user?.name || o.user?.email || 'Unknown',
    total: o.total,
    status: o.status
  }));
  ...
  return (
    <AdminDashboard
      stats={{ totalUsers, totalCourses, totalOrders, revenue, netSalesTotal, marketplaceFeeTotal, activeStudents, pendingWithdrawals }}
